...
from alphagen_ocean.calculator_5d import Calculator5d
...
def main(
    ...
    calculator_train = Calculator5d(data_train, device=DEVICE_CALC)
    calculator_valid = Calculator5d(data_valid, device=DEVICE_CALC)
    calculator_test = Calculator5d(data_test, device=DEVICE_CALC)
