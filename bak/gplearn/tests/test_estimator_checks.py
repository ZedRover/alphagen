...
def test_sklearn_regressor_checks():
    ...
    check_estimator(SymbolicRegressor(population_size=1000, generations=5))


def test_sklearn_classifier_checks():
    """Run the sklearn estimator validation checks on SymbolicClassifier"""

    check_estimator(SymbolicClassifier(population_size=50, generations=5))
...
def test_sklearn_transformer_checks():
    ...
    check_estimator(
        SymbolicTransformer(population_size=50, hall_of_fame=10, generations=5)
    )
